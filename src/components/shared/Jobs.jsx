    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-5xl md:text-6xl font-bold text-violet-950 mb-8">
            Join Us
          </h3>
          <p className="text-xl text-violet-950 mb-12 max-w-3xl mx-auto">
            We're not hiring at the moment, but we're always interested in connecting with talented individuals.
          </p>

          <div className="bg-gradient-to-r from-violet-100 to-purple-100 rounded-2xl p-8 max-w-2xl mx-auto">
            <p className="text-violet-950 mb-4">
              While we don't have any open positions right now, we'd love to hear from you if you're passionate about e-commerce design and photo editing.
            </p>
            <a
